...
mod tests {
    ...
    fn test_mov_mem_disp8() {
        ...
        assert_pcode_contains(
            ...
            &[
                |op| {
                    matches!(op, PcodeOp::IntAdd { left, right, .. }
                if *left == reg(RBP, 8)
                && right.space == AddressSpaceId::Const
                && right.offset == 0xfffffffffffffff0u64)
                },
                |op| {
                    matches!(op, PcodeOp::Load { out, space: AddressSpaceId::Ram, .. }
                if *out == reg(RAX, 8))
                },
            ],
        );
    ...
    fn test_mov_reg_mem_disp() {
        ...
        assert_pcode_contains(
            ...
            &[
                |op| {
                    matches!(op, PcodeOp::IntAdd { right, .. }
    ...
    fn test_test_reg_reg() {
        ...
        assert_pcode_contains(
            ...
            &[
                |op| {
                    matches!(op, PcodeOp::IntAnd { left, right, .. }
    ...
    fn test_jne_rel8() {
        ...
        assert!(
            disasm.contains("JNZ") || disasm.contains("JNE"),
            "expected JNZ, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_sub() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("sub"),
            "expected sub, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_orr() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("orr") || disasm.to_lowercase().contains("mov"),
    ...
    fn test_arm_eor() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("eor"),
            "expected eor, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_mul() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("mul") || disasm.to_lowercase().contains("madd"),
    ...
    fn test_arm_sdiv() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("sdiv"),
            "expected sdiv, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_movz() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("mov"),
            "expected mov/movz, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
            &[|op| {
                matches!(op, PcodeOp::Copy { input, .. }
    ...
    fn test_arm_bl() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("bl"),
            "expected bl, got {disasm}"
        );
        assert_pcode_contains(&pcode, &disasm, &[|op| matches!(op, PcodeOp::Call { .. })]);
    }
    ...
    fn test_arm_b_cond() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("b."),
            "expected b.eq, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_cbnz() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("cbnz"),
            "expected cbnz, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_stp() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("stp"),
            "expected stp, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_ldp() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("ldp"),
            "expected ldp, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_ldr_w_offset() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("ldr"),
            "expected ldr, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_strb() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("strb"),
            "expected strb, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_ldrb() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("ldrb"),
            "expected ldrb, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_str() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("str"),
    ...
    fn test_arm_cmp() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("cmp") || disasm.to_lowercase().contains("subs"),
    ...
    fn test_arm_cbz() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("cbz"),
            "expected CBZ, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm_neg() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("neg") || disasm.to_lowercase().contains("sub"),
    ...
    fn test_arm_mvn() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("mvn") || disasm.to_lowercase().contains("orn"),
    ...
    fn test_arm_tst() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("tst") || disasm.to_lowercase().contains("ands"),
    ...
    fn test_arm_lsr_imm() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("lsr") || disasm.to_lowercase().contains("ubfm"),
    ...
    fn test_arm_asr_imm() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("asr") || disasm.to_lowercase().contains("sbfm"),
    ...
    fn test_arm_sxtw() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("sxtw") || disasm.to_lowercase().contains("sbfm"),
    ...
    fn test_arm_str_pre_index() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("str") || disasm.to_lowercase().contains("stur"),
            "expected str, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
    ...
    fn test_arm_ldrsb() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("ldrsb") || disasm.to_lowercase().contains("ldr"),
    ...
    fn test_arm_csel() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("csel"),
            "expected csel, got {disasm}"
        );
    ...
    fn test_arm_adrp() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("adrp"),
            "expected adrp, got {disasm}"
        );
    }
    ...
    fn test_arm_lsl_imm() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("lsl")
                || disasm.to_lowercase().contains("ubfm")
    ...
    fn test_riscv_or() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("or"),
            "expected or, got {disasm}"
        );
        assert_pcode_contains(&pcode, &disasm, &[|op| matches!(op, PcodeOp::IntOr { .. })]);
    }
    ...
    fn test_riscv_xor() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("xor"),
            "expected xor, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_riscv_slli() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("slli") || disasm.to_lowercase().contains("sll"),
    ...
    fn test_riscv_srli() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("srli") || disasm.to_lowercase().contains("srl"),
    ...
    fn test_riscv_lw() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("lw"),
            "expected lw, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_riscv_sw() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("sw"),
            "expected sw, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_riscv_ld() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("ld"),
            "expected ld, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_riscv_sd() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("sd"),
            "expected sd, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_riscv_lb() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("lb"),
            "expected lb, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_riscv_sb() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("sb"),
            "expected sb, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_riscv_beq() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("beq"),
            "expected beq, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_riscv_bne() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("bne") || disasm.to_lowercase().contains("bnez"),
    ...
    fn test_riscv_jal() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("jal") || disasm.to_lowercase().contains("call"),
    ...
    fn test_riscv_lui() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("lui"),
            "expected lui, got {disasm}"
        );
    }
    ...
    fn test_riscv_slti() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("slti"),
            "expected slti, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_riscv_mul() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("mul"),
            "expected mul, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_mips_addiu() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("addiu") || disasm.to_lowercase().contains("li"),
    ...
    fn test_mips_addu() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("addu") || disasm.to_lowercase().contains("add"),
    ...
    fn test_mips_subu() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("subu") || disasm.to_lowercase().contains("sub"),
    ...
    fn test_mips_sll() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("sll"),
            "expected sll, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_mips_srl() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("srl"),
            "expected srl, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_mips_slt() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("slt"),
            "expected slt, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_mips_beq() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("beq") || disasm.to_lowercase().contains("beqz"),
    ...
    fn test_mips_j() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("j"),
            "expected j, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_mips_jal() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("jal"),
    ...
    fn test_mips_jr_ra() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("jr"),
            "expected jr, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_mips_ori() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("ori"),
            "expected ori, got {disasm}"
        );
        assert_pcode_contains(&pcode, &disasm, &[|op| matches!(op, PcodeOp::IntOr { .. })]);
    }
    ...
    fn test_mips_mult() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("mult"),
            "expected mult, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm32_orr() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("orr"),
            "expected orr, got {disasm}"
        );
        assert_pcode_contains(&pcode, &disasm, &[|op| matches!(op, PcodeOp::IntOr { .. })]);
    }
    ...
    fn test_arm32_mov_imm() {
        ...
        let has_const = pcode.iter().any(|op| match op {
            PcodeOp::Copy { input, .. } => {
                input.space == AddressSpaceId::Const && input.offset == 0x42
            }
            PcodeOp::IntLsr { left, .. } => {
                left.space == AddressSpaceId::Const && left.offset == 0x42
            }
            PcodeOp::IntOr { left, .. } => {
                left.space == AddressSpaceId::Const && left.offset == 0x42
            }
        ...
        assert!(
            has_const,
            "MOV R0,#0x42 should reference constant 0x42\n{pcode:#?}"
        );
    }
    ...
    fn test_arm32_mov_reg() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("mov") || disasm.to_lowercase().contains("cpy"),
            "expected mov, got {disasm}"
        );
        assert_pcode_contains(&pcode, &disasm, &[|op| matches!(op, PcodeOp::Copy { .. })]);
    }
    ...
    fn test_arm32_cmp() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("cmp"),
            "expected cmp, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
    ...
    fn test_arm32_push() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("stm") || disasm.to_lowercase().contains("push"),
    ...
    fn test_arm32_pop() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("ldm") || disasm.to_lowercase().contains("pop"),
    ...
    fn test_arm32_bx_lr() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("bx"),
            "expected bx, got {disasm}"
        );
        assert_pcode_contains(
            &pcode,
            &disasm,
    ...
    fn test_arm32_lsl_imm() {
        ...
        assert_eq!(len, 4);
        assert!(
            disasm.to_lowercase().contains("lsl") || disasm.to_lowercase().contains("mov"),
    ...
    fn run_stress_tests() {
        ...
        // REX.B selects R8-R15 registers
        {
            ...
            assert!(
                disasm.contains("R8"),
                "REX.B should select R8, got {disasm}"
            );
            assert_pcode_contains(
                &pcode,
                &disasm,
        ...
        }
        {
            ...
            assert!(
                disasm.contains("R15"),
                "REX.B+reg=7 should select R15, got {disasm}"
            );
        }
        {
            let (_len, disasm, _pcode) = decode(&[0x41, 0x89, 0xc8], 0x1000); // MOV R8D, ECX
            assert!(
                disasm.contains("R8") || disasm.contains("r8"),
        ...
        // --- Sign-extended immediate edge cases ---
        {
            ...
            let (_len, disasm, pcode) = decode(&[0x48, 0xc7, 0xc0, 0xff, 0xff, 0xff, 0xff], 0x1000);
            assert!(
                disasm.contains("MOV") && disasm.contains("RAX"),
                "got {disasm}"
            );
        ...
        // --- Backward branch displacement (sign extension) ---
        {
            ...
            assert!(
                ...
                "JMP -2 at 0x1000 should target 0x1000, got {disasm}"
            );
            assert_pcode_contains(
                &pcode,
                &disasm,
        ...
        }
        {
            ...
            assert_eq!(len, 4);
            assert!(
                disasm.to_lowercase().contains("madd") || disasm.to_lowercase().contains("mul"),
        ...
        // --- RISC-V edge cases ---
        {
            ...
            assert!(
                disasm.to_lowercase().contains("addi"),
                "expected addi, got {disasm}"
            );
            ...
            assert_pcode_contains(
                ...
                &[
                    ...
                    && right.offset > 0x7FFFFFFFFFFFFFFF)
                    }, // negative when sign-extended
                ],
            );
        }
        {
            ...
            assert!(
                disasm.to_lowercase().contains("nop") || disasm.to_lowercase().contains("c.nop"),
        ...
        // --- MIPS delay slot ---
        {
            ...
            assert_eq!(len, 4);
            assert!(
                disasm.to_lowercase().contains("nop") || disasm.to_lowercase().contains("sll"),
    ...
    fn test_x86_function_prologue_epilogue() {
        ...
        assert_eq!(
            seq.len(),
            3,
            "prologue should be 3 instructions, got {}",
            seq.len()
        );
        assert!(
            seq[0].2.contains("PUSH"),
            "first should be PUSH, got {}",
            seq[0].2
        );
        assert!(
            seq[1].2.contains("MOV"),
            "second should be MOV, got {}",
            seq[1].2
        );
        assert!(
            seq[2].2.contains("SUB"),
            "third should be SUB, got {}",
            seq[2].2
        );
        ...
        assert!(
            push_pcode.iter().any(
                |op| matches!(op, PcodeOp::Store { space: AddressSpaceId::Ram, val, .. }
            if *val == reg(RBP, 8))
            ),
            "PUSH should store RBP"
        );
        let mov_pcode = &seq[1].3;
        assert!(
            mov_pcode
                .iter()
                .any(|op| matches!(op, PcodeOp::Copy { out, input }
            if *out == reg(RBP, 8) && *input == reg(RSP, 8))),
            "MOV should copy RSP→RBP"
        );
    ...
    fn test_x86_stack_locals() {
        ...
        assert!(
            has_neg8,
            "displacement -8 should be sign-extended to 0xFFFFFFFFFFFFFFF8\n{store_ops:#?}"
        );
    ...
    fn test_x86_call_with_args() {
        ...
        assert_eq!(
            seq.len(),
            3,
            "should decode 3 instructions, got {}",
            seq.len()
        );
        ...
        assert!(
            seq[0]
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::Copy { input, .. }
        ...
        assert!(
            seq[2].3.iter().any(|op| matches!(op, PcodeOp::Call { dest }
            if dest.offset == 0x1100)),
            "call should target 0x1100, pcode: {:#?}",
            seq[2].3
        );
    }
    ...
    fn test_x86_compare_and_branch() {
        ...
        assert!(
            seq[0]
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::IntAnd { left, right, .. }
        ...
        assert!(
            seq[0]
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::IntEq { out, .. }
            if *out == reg(ZF, 1))),
            "TEST should set ZF"
        );
        ...
        assert!(
            seq[1]
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::CBranch { dest, cond }
    ...
    fn test_x86_loop_pattern() {
        ...
        assert!(
            seq[1]
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::IntSub { .. })),
        ...
        assert!(
            seq[2]
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::CBranch { dest, .. }
    ...
    fn test_x86_rip_relative_data() {
        ...
        assert!(
            writes_rdi,
            "LEA [rip+disp] should write to RDI\n{lea_ops:#?}"
        );
        // Should NOT have a Load (LEA computes address only)
        assert!(
            !lea_ops.iter().any(|op| matches!(op, PcodeOp::Load { .. })),
    ...
    fn test_x86_sign_extend_chain() {
        ...
        assert!(
            seq[0]
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::IntSext { .. })),
        ...
        assert!(
            seq[1]
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::IntSext { out, .. }
            if *out == reg(RAX, 8))),
    ...
    fn test_arm64_function_prologue_epilogue() {
        ...
        let store_count = stp_ops
            .iter()
            .filter(|op| matches!(op, PcodeOp::Store { .. }))
            .count();
        assert!(
            store_count >= 2,
            "STP x29,x30 should produce at least 2 Stores, got {store_count}\n{stp_ops:#?}"
        );
        ...
        let load_count = ldp_ops
            .iter()
            .filter(|op| matches!(op, PcodeOp::Load { .. }))
            .count();
        assert!(
            load_count >= 2,
            "LDP should produce at least 2 Loads, got {load_count}"
        );
        // RET
        assert!(
            eseq[1]
    ...
    fn test_arm64_compare_and_branch() {
        ...
        assert!(
            seq[0]
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::CBranch { .. })),
    ...
    fn run_bug_probes() {
        ...
        {
            let (_len, _disasm, pcode) =
                decode(&[0x48, 0xc7, 0xc0, 0x00, 0x00, 0x00, 0x80], 0x1000);
            // 0x80000000 as signed i32 = -2147483648, sign-extends to 0xFFFFFFFF80000000
            let has_sext = pcode.iter().any(|op| match op {
                PcodeOp::Copy { input, .. } => {
                    input.space == AddressSpaceId::Const && input.offset == 0xFFFFFFFF80000000
                }
                _ => false,
            });
            assert!(
        ...
        // imm8 boundary: ADD RAX, 0x7F (positive max of signed byte, should stay positive)
        {
            ...
            assert!(
                has_positive,
                "imm8=0x7F should stay 0x7F (positive)\n{pcode:#?}"
            );
        }
        ...
        // After: XOR EAX, EAX should produce zero, not leave old upper bits
        {
            ...
            assert!(
                writes_eax,
                "XOR EAX,EAX should write 4-byte EAX\n{pcode:#?}"
            );
        }
        ...
        // CALL -5 (E8 FB FF FF FF) at 0x1000 → target = 0x1000 + 5 + (-5) = 0x1000
        {
            ...
            assert!(
                pcode.iter().any(|op| matches!(op, PcodeOp::Call { dest }
        ...
        // JMP rel32 backward: E9 F6 FF FF FF at 0x1000 → 0x1000 + 5 - 10 = 0xFFB
        {
            ...
            assert!(
                pcode.iter().any(|op| matches!(op, PcodeOp::Branch { dest }
        ...
        {
            let (_len, _, lea_pcode) =
                decode(&[0x48, 0x8d, 0x04, 0x25, 0x00, 0x10, 0x00, 0x00], 0x1000);
            // LEA RAX, [0x1000]  — computes address only
            assert!(
                !lea_pcode
                    .iter()
                    .any(|op| matches!(op, PcodeOp::Load { .. })),
                "LEA should never Load\n{lea_pcode:#?}"
            );

            let (_len, _, mov_pcode) =
                decode(&[0x48, 0x8b, 0x04, 0x25, 0x00, 0x10, 0x00, 0x00], 0x1000);
        ...
        // ── x86-64: all conditional branches resolve correct targets ──
        {
            ...
            for (opcode, name) in jcc_opcodes {
                ...
                let has_cbranch = pcode.iter().any(|op| {
                    matches!(op, PcodeOp::CBranch { dest, .. }
                    if dest.offset == 0x1012)
                });
                assert!(
                    has_cbranch,
                    "{name} +0x10 at 0x1000 should target 0x1012\npcode: {pcode:#?}"
                );
            }
        }
        ...
        // B-type: BEQ x0, x0, backward (13-bit signed offset)
        {
            ...
            if let Ok((_len, disasm, pcode)) = result {
                if disasm.to_lowercase().contains("beq") {
                    let has_backward = pcode.iter().any(|op| {
                        matches!(op, PcodeOp::CBranch { dest, .. }
                        if dest.offset < 0x1000)
                    });
                    assert!(
        ...
        // J-type: JAL x1, negative offset (21-bit signed)
        {
            ...
            assert!(
                has_backward,
                "RISC-V JAL backward should target before 0x1000\npcode: {pcode:#?}"
            );
        }
        ...
        // I-type: ADDI x1, x1, -2048 (minimum 12-bit signed = 0x800)
        {
            ...
            assert!(
                has_neg,
                "ADDI x1,x1,-2048 should have negative constant\n{pcode:#?}"
            );
        }
        ...
        // I-type: ADDI x1, x1, 2047 (maximum positive 12-bit signed = 0x7FF)
        {
            ...
            assert!(
                has_pos,
                "ADDI x1,x1,2047 should have constant 2047\n{pcode:#?}"
            );
        }
        ...
        // ADD X0, X0, #0xFFF (maximum 12-bit unsigned immediate)
        {
            ...
            assert!(
                has_fff,
                "ADD X0,X0,#0xFFF should have constant 0xFFF\n{pcode:#?}"
            );
        }
        ...
        // SUB SP, SP, #0x100 (common stack allocation)
        {
            ...
            assert!(
                pcode.iter().any(|op| matches!(op, PcodeOp::IntSub { .. })),
        ...
        // x86: variable-length instructions
        {
            ...
            assert_eq!(
                decode(&[0x48, 0x89, 0xc7], 0x1000).0,
                3,
                "MOV RDI,RAX = 3 bytes"
            );
            assert_eq!(
                decode(&[0xe8, 0x00, 0x01, 0x00, 0x00], 0x1000).0,
                5,
                "CALL rel32 = 5 bytes"
            );
            assert_eq!(
        ...
        // ModRM with mod=00 rm=101 means [RIP+disp32], not [RBP].
        {
            ...
            assert!(
                disasm.contains("MOV") && disasm.contains("RBP"),
                "got {disasm}"
            );
        ...
        // MOV RAX, [RSP] = 48 8B 04 24 (needs SIB: base=RSP, index=none, scale=1)
        {
            ...
            assert!(
                disasm.contains("MOV") && disasm.contains("RSP"),
                "got {disasm}"
            );
            assert!(
                pcode.iter().any(
        ...
        // MOV AX, 0x1234 (66 B8 34 12) — 16-bit register write
        {
            ...
            assert!(
                disasm.contains("AX") || disasm.contains("ax"),
                "got {disasm}"
            );
            ...
            assert!(
                has_16bit,
                "66h MOV AX,0x1234 should write 2-byte const 0x1234\n{pcode:#?}"
            );
        }
        ...
        // Verify all 16 GPRs are addressable
        {
            ...
            assert!(
                disasm.contains("R12"),
                "REX.B + rm=4 should select R12, got {disasm}"
            );
            assert!(
                pcode.iter().any(|op| matches!(op, PcodeOp::Copy { out, .. }
            ...
            assert!(
                disasm.contains("R13"),
                "REX.B + rm=5 should select R13, got {disasm}"
            );
            ...
            assert!(
                disasm.contains("R9"),
                "REX.R should select R9, got {disasm}"
            );
        }
        ...
        // MUL RCX = 48 F7 E1 — unsigned multiply RAX*RCX → RDX:RAX
        {
            ...
            assert!(
                writes_rdx,
                "MUL should write result high to RDX\n{pcode:#?}"
            );
        }
        ...
        // MOVZX EAX, byte ptr [RDI] = 0F B6 07
        {
            ...
            let has_byte_load = pcode.iter().any(|op| {
                matches!(op, PcodeOp::Load { out, .. }
                if out.size == 1)
            });
            let has_zext = pcode.iter().any(|op| {
                matches!(op, PcodeOp::IntZext { out, .. }
                if out.size == 4)
            });
        ...
        // MOVSX EAX, word ptr [RDI] = 0F BF 07
        {
            ...
            let has_word_load = pcode.iter().any(|op| {
                matches!(op, PcodeOp::Load { out, .. }
                if out.size == 2)
            });
            let has_sext = pcode.iter().any(|op| {
                matches!(op, PcodeOp::IntSext { out, .. }
                if out.size == 4)
            });
        ...
        // CQO; IDIV RCX = 48 99; 48 F7 F9
        {
            ...
            assert!(
                last.2.contains("IDIV"),
                "last should be IDIV, got {}",
                last.2
            );
            ...
            let has_sdiv = last
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::IntSDiv { .. }));
            let has_srem = last
                .3
                .iter()
                .any(|op| matches!(op, PcodeOp::IntSRem { .. }));
        ...
        {
            let (len, disasm, pcode) =
                decode(&[0x48, 0x8d, 0x84, 0x8b, 0x00, 0x01, 0x00, 0x00], 0x1000);
            ...
            let has_mult = pcode
                .iter()
                .any(|op| matches!(op, PcodeOp::IntMult { .. } | PcodeOp::IntLsl { .. }));
            assert!(
                has_mult || pcode.len() >= 2,
                "LEA [base+idx*4+disp] should have scale computation\n{pcode:#?}"
            );
            // Should NOT Load from memory
            assert!(
                !pcode.iter().any(|op| matches!(op, PcodeOp::Load { .. })),
                "LEA should NOT Load"
            );
        }
        ...
        // TEST RAX, 1 = 48 A9 01 00 00 00
        {
            ...
            assert!(
                !writes_rax,
                "TEST should NOT write to RAX (flag-only)\n{pcode:#?}"
            );
            assert!(
                pcode
                    .iter()
        ...
        // ── ARM64 PC-relative branch offset correctness ──
        {
            ...
            assert!(
                pcode
                    .iter()
                    .any(|op| matches!(op, PcodeOp::Branch { dest } if dest.offset == 0x1008)),
                "B +8 at 0x1000 should target 0x1008\n{pcode:#?}"
            );
        }
        {
            ...
            assert!(
                pcode
                    .iter()
                    .any(|op| matches!(op, PcodeOp::Branch { dest } if dest.offset == 0xFFC)),
                "B -4 at 0x1000 should target 0xFFC\n{pcode:#?}"
            );
        }
        {
            ...
            assert!(
                pcode
                    .iter()
                    .any(|op| matches!(op, PcodeOp::Call { dest } if dest.offset == 0x1100)),
        ...
        }
        {
            ...
            assert!(
                pcode
                    .iter()
                    .any(|op| matches!(op, PcodeOp::Call { dest } if dest.offset == 0xFFC)),
        ...
        // ADDS X0, X1, X2 = 0xAB020020
        {
            ...
            assert!(
                disasm.to_lowercase().contains("adds") || disasm.to_lowercase().contains("cmn"),
                "got {disasm}"
            );
            ...
            let sets_flags = pcode.iter().any(|op| match op {
                ...
                | PcodeOp::IntSCarry { out, .. } => {
                    out.space == AddressSpaceId::Register && (256..=264).contains(&out.offset)
                } // ARM64 flag range
                _ => false,
            });
        ...
        // LDRB W0, [X1] loads 1 byte
        {
            ...
            assert!(
                pcode
                    .iter()
                    .any(|op| matches!(op, PcodeOp::Load { out, .. } if out.size == 1)),
        ...
        // LDRH W0, [X1] loads 2 bytes
        {
            ...
            assert!(
                pcode
                    .iter()
                    .any(|op| matches!(op, PcodeOp::Load { out, .. } if out.size == 2)),
        ...
        // LDR W0, [X1] loads 4 bytes
        {
            ...
            assert!(
                pcode
                    .iter()
                    .any(|op| matches!(op, PcodeOp::Load { out, .. } if out.size == 4)),
        ...
        // LDR X0, [X1] loads 8 bytes
        {
            ...
            assert!(
                pcode
                    .iter()
                    .any(|op| matches!(op, PcodeOp::Load { out, .. } if out.size == 8)),
        ...
        // STRB W0, [X1] stores 1 byte
        {
            ...
            assert!(
                pcode.iter().any(|op| matches!(op, PcodeOp::Store { .. })),
                "STRB should Store\n{pcode:#?}"
            );
        }
        ...
        // SUBS W0, W1, W2 = 0x6B020020 (32-bit subtract with flags)
        {
            ...
            let has_32bit_sub = pcode.iter().any(|op| {
                matches!(op, PcodeOp::IntSub { out, .. }
                if out.size == 4)
            });
            assert!(
                has_32bit_sub,
                "SUBS W should produce 4-byte IntSub\n{pcode:#?}"
            );
        }
        ...
        // MOV SP, X0 = ADD SP, X0, #0 = 0x9100001F
        {
            ...
            assert!(
                disasm.to_lowercase().contains("mov") || disasm.to_lowercase().contains("add"),
                "got {disasm}"
            );
        ...
        // LDRSW X0, [X1] = 0xB9800020
        {
            ...
            assert!(
                disasm.to_lowercase().contains("ldrsw") || disasm.to_lowercase().contains("ldr"),
                "got {disasm}"
            );
        ...
        // MADD X0, X1, X2, X3 = 0x9B020C20
        {
            ...
            assert!(
                pcode.iter().any(|op| matches!(op, PcodeOp::IntMult { .. })),
        ...
        // UBFM X0, X1, #4, #11 = 0xD340AC20
        {
            ...
            assert!(
                disasm.to_lowercase().contains("ubfx")
                    || disasm.to_lowercase().contains("ubfm")
        ...
        // 0x8B22C020
        {
            ...
            assert!(
                has_sext,
                "ADD X0,X1,W2,SXTW should sign-extend W2\n{pcode:#?}"
            );
        }
        ...
        // 64 48 8B 04 25 28 00 00 00
        {
            ...
            match result {
                Ok((len, disasm, pcode)) => {
                    ...
                    assert!(
                        disasm.contains("FS") || disasm.contains("fs"),
        ...
        // 48 83 E4 F0
        {
            ...
            let has_mask = pcode.iter().any(|op| match op {
                PcodeOp::IntAnd { right, .. } | PcodeOp::Copy { input: right, .. } => {
                    right.space == AddressSpaceId::Const && right.offset == 0xFFFFFFFFFFFFFFF0
                }
                _ => false,
            });
            assert!(
        ...
        // ── Indirect call through memory: CALL [RAX] vs CALL RAX ──
        {
            ...
            assert!(
                pcode1
                    .iter()
                    .any(|op| matches!(op, PcodeOp::CallInd { dest }
                if *dest == reg(RAX, 8))),
        ...
        // F3 A4
        {
            let result = std::panic::catch_unwind(|| decode(&[0xf3, 0xa4], 0x1000));
            match result {
                Ok((_len, disasm, pcode)) => {
                    assert!(
                        disasm.contains("MOVS") || disasm.contains("REP"),
        ...
        {
            let result =
                std::panic::catch_unwind(|| decode(&[0xf0, 0x48, 0x0f, 0xc1, 0x07], 0x1000));
            match result {
        ...
        // F2 0F 58 C1
        {
            let result = std::panic::catch_unwind(|| decode(&[0xf2, 0x0f, 0x58, 0xc1], 0x1000));
            match result {
                Ok((_len, disasm, pcode)) => {
                    assert!(
                        disasm.contains("ADDSD") || disasm.contains("addsd"),
                        "expected ADDSD, got {disasm}"
                    );
                    assert!(
                        pcode
                            .iter()
                            .any(|op| matches!(op, PcodeOp::FloatAdd { .. })),
        ...
        {
            let result = std::panic::catch_unwind(|| decode(&[0xf2, 0x0f, 0x10, 0x07], 0x1000));
            match result {
                Ok((_len, disasm, pcode)) => {
                    assert!(
                        disasm.contains("MOVSD") || disasm.contains("movsd"),
        ...
        // 0F 05
        {
            let result = std::panic::catch_unwind(|| decode(&[0x0f, 0x05], 0x1000));
            match result {
                Ok((_len, disasm, _pcode)) => {
        ...
        // ── PLT/GOT pattern: MOV [RIP+disp], value; then CALL [RIP+disp] ──
        {
            ...
            assert!(
                seq[0].3.iter().any(|op| matches!(op, PcodeOp::Load { .. })),
        ...
        // TBZ X0, #0, +8 = 0x36000040
        {
            ...
            assert!(
                disasm.to_lowercase().contains("tbz"),
                "expected TBZ, got {disasm}"
            );
            assert!(
                pcode.iter().any(|op| matches!(op, PcodeOp::CBranch { .. })),
        ...
        // TBNZ X0, #0, +8 = 0x37000040
        {
            ...
            assert!(
                disasm.to_lowercase().contains("tbnz"),
                "expected TBNZ, got {disasm}"
            );
            assert!(
                pcode.iter().any(|op| matches!(op, PcodeOp::CBranch { .. })),
        ...
        // TBZ X0, #0, -4 = 0x3607FFE0
        {
            ...
            assert!(
                target.map_or(false, |t| t < 0x1000),
        ...
        // CSET X0, EQ = CSINC X0, XZR, XZR, NE = 0x9A9F17E0
        {
            ...
            assert!(
                disasm.to_lowercase().contains("cset") || disasm.to_lowercase().contains("csinc"),
        ...
        // 0xF8408420
        {
            ...
            assert!(
                pcode.iter().any(|op| matches!(op, PcodeOp::IntAdd { .. })),
        ...
        // ── ADRP + LDR sequence: global variable access ──
        {
            ...
            assert!(!seq[0].3.is_empty(), "ADRP should produce P-code");
            assert!(
                seq[1].3.iter().any(|op| matches!(op, PcodeOp::Load { .. })),
        ...
        // STP X29, X30, [SP, #-48]! = 0xA9BD7BFD
        {
            ...
            let store_count = pcode
                .iter()
                .filter(|op| matches!(op, PcodeOp::Store { .. }))
                .count();
            assert!(
                store_count >= 2,
                "STP should produce 2+ Stores, got {store_count}"
            );
        }
        ...
        {
            let result =
                std::panic::catch_unwind(|| arm::decode(&[0x40, 0xd0, 0x3b, 0xd5], 0x1000));
            match result {
                Ok((len, disasm, _pcode)) => {
                    assert_eq!(len, 4);
                    assert!(
                        disasm.to_lowercase().contains("mrs")
                            || disasm.to_lowercase().contains("tpidr"),
        ...
        // CSINC X0, X1, X2, EQ = 0x9A820420
        {
            ...
            assert!(
                disasm.to_lowercase().contains("csinc") || disasm.to_lowercase().contains("cinc"),
        ...
        // UXTH W0, W1 = UBFM W0, W1, #0, #15 = 0x53003C20
        {
            ...
            assert!(
                disasm.to_lowercase().contains("uxth")
                    || disasm.to_lowercase().contains("ubfm")
                    || disasm.to_lowercase().contains("and"),
        ...
        {
            let result =
                std::panic::catch_unwind(|| arm::decode(&[0xbf, 0x3b, 0x03, 0xd5], 0x1000));
            match result {
                Ok((len, disasm, _)) => {
                    assert_eq!(len, 4);
                    assert!(
                        disasm.to_lowercase().contains("dmb"),
...
"#;
        ...
        let (segs, symbols) = match &obj {
            goblin::Object::Mach(goblin::mach::Mach::Binary(m)) => {
                let segs: Vec<(u64, u64, u64)> = m
                    .segments
                    .iter()
                    .map(|s| (s.vmaddr, s.vmsize, s.fileoff))
                    .collect();
                let mut syms = Vec::new();
                for sym in m.symbols() {
                    if let Ok((name, nlist)) = sym {
                        if nlist.n_type & 0x0e == 0x0e && nlist.n_value != 0 {
                            let c: &str = if name.starts_with('_') {
                                &name[1..]
                            } else {
                                name
                            };
        ...
        if let Some(addr) = find_addr("add") {
            ...
            if dsym_exists {
                assert!(
                    output.contains("a + b") || output.contains("a +"),
        ...
        if let Some(addr) = find_addr("factorial") {
            ...
            assert!(
                output.contains("1"),
                "factorial(): should contain base case 1\n{}",
                output
            );
            assert!(
                output.contains("n - 1") || output.contains("n-1") || output.contains("n +"),
            ...
            if dsym_exists {
                assert!(
                    output.contains(" n ") || output.contains("(n ") || output.contains(" n)"),
        ...
        if let Some(addr) = find_addr("reverse_string") {
            ...
            if dsym_exists {
                assert!(
                    output.contains("str") || output.contains("param_0"),
        ...
        if let Some(addr) = find_addr("main") {
            ...
            // String literals
            assert!(
                output.contains("add(3, 4)") || output.contains("add(3,4)"),
                "main(): should contain 'add(3, 4)' string literal\n{}",
                output
            );
            assert!(
                output.contains("factorial(5)"),
            ...
            assert!(
                output.contains("reverse_string("),
                "main(): should call reverse_string()\n{}",
                output
            );
            assert!(
                output.contains("strcpy("),
                "main(): should call strcpy()\n{}",
                output
            );
            assert!(
    ...
    fn run_spectra_decoder_tests() {
        ...
        // Test: x86-64 decode produces correct disassembly + P-code
        {
            ...
            assert!(
                inst.disassembly.contains("CALL"),
                "Expected CALL, got: {}",
                inst.disassembly
            );
            // CALL must produce a Call P-code op
            assert!(
                inst.ops.iter().any(|op| matches!(op, PcodeOp::Call { .. })),
    ...
    fn run_spectra_decompile_tests() {
        ...
        // MOV EAX, EDI; ADD EAX, ESI; RET
        {
            ...
            assert!(
                output.contains("func_") || output.contains("("),
                ...
                if out.status.success() {
                        ...
                        goblin::Object::parse(&data)
                    {
                        ...
                        if let Some(func_addr) = add_addr {
                            ...
                            let text_seg = m.segments.iter().find(|s| {
                                std::str::from_utf8(&s.segname)
                                    .unwrap_or("")
                                    .trim_end_matches('\0')
                                    == "__TEXT"
                            });
                            ...
                            if let Some(seg) = text_seg {
                                ...
                                assert!(
                                    output.contains("return") || output.contains("param"),
                                    "add() should reference params or return: {}",
                                    output
                                );
...
"#;
            let meta =
                rsleigh_decompile::analysis::extract_function_meta("main", 0x1000, pseudocode);
            assert_eq!(meta.name, "main");
            assert_eq!(meta.address, 0x1000);
            assert!(
                meta.calls.contains(&"printf".to_string()),
                "Should detect printf call"
            );
            assert!(
                meta.calls.contains(&"malloc".to_string()),
                "Should detect malloc call"
            );
            assert!(
                meta.strings.iter().any(|s| s.contains("hello")),
            ...
            // Behavioral tags
            assert!(
                meta.tags.contains(&"network".to_string())
                    || meta.tags.contains(&"input".to_string()),
                "recv() should tag as network/input: {:?}",
                meta.tags
            );
            assert!(
                meta.tags.contains(&"exec".to_string()),
                "system() should tag as exec: {:?}",
                meta.tags
            );
            ...
            eprintln!(
                "  extract_function_meta: ok ({} calls, {} tags)",
                meta.calls.len(),
                meta.tags.len()
            );
        }
...
"#;
            ...
            assert!(
                !vulns.is_empty(),
                "Should detect vulnerabilities in unsafe code"
            );
            ...
            let high_count = vulns
                .iter()
                .filter(|v| v.severity == "HIGH" || v.severity == "CRIT")
                .count();
            assert!(
                high_count > 0,
                "strcpy/gets/system should produce HIGH/CRIT findings, got: {:?}",
                vulns
                    .iter()
...
"#;
            ...
            let crit_high = vulns
                .iter()
                .filter(|v| v.severity == "CRIT" || v.severity == "HIGH")
                .count();
            assert_eq!(
                crit_high,
                0,
                "Safe code should not have CRIT/HIGH vulns: {:?}",
                vulns
                    .iter()
                    .map(|v| format!("{}: {}", v.severity, v.description))
                    .collect::<Vec<_>>()
    ...
    fn run_spectra_multi_arch_tests() {
        ...
        let test_cases: &[(Architecture, &[u8], &str)] = &[
            ...
            (
                Architecture::MIPS32,
                &[
                    0x24, 0x02, 0x00, 0x00, 0x03, 0xe0, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00,
                ],
                "MIPS32",
            ),
            ...
            (
                Architecture::RiscV64,
                &[0x13, 0x05, 0x05, 0x00, 0x67, 0x80, 0x00, 0x00],
                "RV64",
            ),
        ];
        ...
        for (arch, bytes, name) in test_cases {
            ...
            assert!(
                !insts.is_empty(),
                "{}: should decode at least 1 instruction",
                name
            );
            ...
            assert!(
                !output.is_empty(),
                "{}: decompiled output should not be empty",
                name
            );
            eprintln!(
                "  {}: decoded {} insts, decompiled {} chars",
                name,
                insts.len(),
                output.len()
            );

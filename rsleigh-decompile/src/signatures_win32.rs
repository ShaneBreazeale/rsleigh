...
pub static WIN32_SIGNATURES: &[FuncSig] = crate::define_signatures! {
    ...
    fn ControlService(hService: VoidPtr, dwControl: DWord, lpServiceStatus: VoidPtr) -> Int;
    ...
    fn CreateServiceA(hSCManager: Handle, lpServiceName: ConstCharPtr, lpDisplayName: ConstCharPtr, dwDesiredAccess: DWord, dwServiceType: DWord, dwStartType: DWord, dwErrorControl: DWord, lpBinaryPathName: ConstCharPtr, lpLoadOrderGroup: ConstCharPtr, lpdwTagId: VoidPtr, lpDependencies: ConstCharPtr, lpServiceStartName: ConstCharPtr, lpPassword: ConstCharPtr) -> Handle;
    fn CreateServiceW(hSCManager: Handle, lpServiceName: ConstWCharPtr, lpDisplayName: ConstWCharPtr, dwDesiredAccess: DWord, dwServiceType: DWord, dwStartType: DWord, dwErrorControl: DWord, lpBinaryPathName: ConstWCharPtr, lpLoadOrderGroup: ConstWCharPtr, lpdwTagId: VoidPtr, lpDependencies: ConstWCharPtr, lpServiceStartName: ConstWCharPtr, lpPassword: ConstWCharPtr) -> Handle;
    ...
    fn DeleteService(hService: Handle) -> Int;
    ...
    fn FindWindowA(lpClassName: ConstCharPtr, lpWindowName: ConstCharPtr) -> Handle;
    fn FindWindowW(lpClassName: ConstWCharPtr, lpWindowName: ConstWCharPtr) -> Handle;
    ...
    fn GetWindowTextA(hWnd: Handle, lpString: CharPtr, nMaxCount: Int) -> Int;
    fn GetWindowTextW(hWnd: Handle, lpString: WCharPtr, nMaxCount: Int) -> Int;
    ...
    fn MessageBoxA(hWnd: Handle, lpText: ConstCharPtr, lpCaption: ConstCharPtr, uType: UInt) -> Int;
    fn MessageBoxW(hWnd: Handle, lpText: ConstWCharPtr, lpCaption: ConstWCharPtr, uType: UInt) -> Int;
    ...
    fn NtQueryInformationProcess(ProcessHandle: Handle, ProcessInformationClass: Int, ProcessInformation: VoidPtr, ProcessInformationLength: UInt, ReturnLength: VoidPtr) -> Long;
    fn NtQuerySystemInformation(SystemInformationClass: Int, SystemInformation: VoidPtr, SystemInformationLength: UInt, ReturnLength: VoidPtr) -> Long;
    fn OpenProcess(dwDesiredAccess: DWord, bInheritHandle: Int, dwProcessId: DWord) -> Handle;
    fn OpenSCManagerA(lpMachineName: ConstCharPtr, lpDatabaseName: ConstCharPtr, dwDesiredAccess: DWord) -> Handle;
    fn OpenSCManagerW(lpMachineName: ConstWCharPtr, lpDatabaseName: ConstWCharPtr, dwDesiredAccess: DWord) -> Handle;
    fn OpenServiceA(hSCManager: Handle, lpServiceName: ConstCharPtr, dwDesiredAccess: DWord) -> Handle;
    fn OpenServiceW(hSCManager: Handle, lpServiceName: ConstWCharPtr, dwDesiredAccess: DWord) -> Handle;
    fn OutputDebugStringA(lpOutputString: ConstCharPtr);
    fn OutputDebugStringW(lpOutputString: ConstWCharPtr);
    fn PostMessageA(hWnd: Handle, Msg: UInt, wParam: ULong, lParam: Long) -> Int;
    fn PostMessageW(hWnd: Handle, Msg: UInt, wParam: ULong, lParam: Long) -> Int;
    ...
    fn RegCloseKey(hKey: Handle) -> Long;
    fn RegCreateKeyExA(hKey: Handle, lpSubKey: ConstCharPtr, Reserved: DWord, lpClass: CharPtr, dwOptions: DWord, samDesired: DWord, lpSecurityAttributes: VoidPtr, phkResult: VoidPtr, lpdwDisposition: VoidPtr) -> Long;
    fn RegOpenKeyExW(hKey: Handle, lpSubKey: ConstWCharPtr, ulOptions: DWord, samDesired: DWord, phkResult: VoidPtr) -> Long;
    fn RegQueryValueExA(hKey: Handle, lpValueName: ConstCharPtr, lpReserved: VoidPtr, lpType: VoidPtr, lpData: VoidPtr, lpcbData: VoidPtr) -> Long;
    fn RegQueryValueExW(hKey: Handle, lpValueName: ConstWCharPtr, lpReserved: VoidPtr, lpType: VoidPtr, lpData: VoidPtr, lpcbData: VoidPtr) -> Long;
    fn RegSetValueExW(hKey: Handle, lpValueName: ConstWCharPtr, Reserved: DWord, dwType: DWord, lpData: ConstVoidPtr, cbData: DWord) -> Long;
    fn ReleaseMutex(hMutex: Handle) -> Int;
    fn ResetEvent(hEvent: Handle) -> Int;
    fn SendMessageA(hWnd: Handle, Msg: UInt, wParam: ULong, lParam: Long) -> Long;
    fn SendMessageW(hWnd: Handle, Msg: UInt, wParam: ULong, lParam: Long) -> Long;
    ...
    fn StartServiceA(hService: Handle, dwNumServiceArgs: DWord, lpServiceArgVectors: VoidPtr) -> Int;
    fn TerminateProcess(hProcess: Handle, uExitCode: UInt) -> Int;
    fn URLDownloadToFileA(pCaller: VoidPtr, szURL: ConstCharPtr, szFileName: ConstCharPtr, Reserved: DWord, lpfnCB: VoidPtr) -> Long;
    fn URLDownloadToFileW(pCaller: VoidPtr, szURL: ConstWCharPtr, szFileName: ConstWCharPtr, Reserved: DWord, lpfnCB: VoidPtr) -> Long;
